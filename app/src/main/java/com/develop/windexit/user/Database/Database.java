package com.develop.windexit.user.Database;
...
public class Database extends SQLiteAssetHelper {
    ...
    private static final String DB_NAME = "chakrabbarty.db";
    ...
    public void addToFavorites(Favorites food) {
        SQLiteDatabase db = getReadableDatabase();
        String query = String.format("INSERT INTO Favorites(FoodId,FoodName,FoodPrice,FoodMenuId,FoodImage,FoodDescription,Available,UserPhone) " +
    ...
    public List<Favorites> getAllFavorites(String userPhone) {
        ...
        SQLiteDatabase db = getReadableDatabase();
        SQLiteQueryBuilder qb = new SQLiteQueryBuilder();
        String[] sqlSelect = {"UserPhone", "FoodId", "FoodName", "FoodPrice", "FoodMenuId", "FoodImage","Available","FoodDescription"};
